...
![image](https://pic.winsky.wang/images/2018/08/12/7004b8ee.png)
...
2. HashMap的put方法
    ![image](https://pic.winsky.wang/images/2018/08/12/9839d16b2f8d488f3400dda385f993e1.png)
...
2. 另外一个比较明显的线程不安全的问题是HashMap的get操作可能因为resize而引起死循环（cpu100%），具体分析如下：
    ...
    ![image](https://pic.winsky.wang/images/2018/08/12/700.png)
